...
public class TematicaLogicTest 
{
    ...
    private void insertData() 
    {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            System.out.println("fin for 1/n/n/n/n/n/n/n/n/n");
        }
        for (int i = 0; i < 3; i++) 
        {
            ...
            em.persist(entity);
            data.add(entity);
            System.out.println("fin for 2/n/n/n/n/n/n/n/n/n/n");
        }
    }
    ...
    public void addServiciosTest() {
        ...
        ServicioEntity response = tematicaLogic.addServicio(servicioEntity.getId(), entity.getId());
