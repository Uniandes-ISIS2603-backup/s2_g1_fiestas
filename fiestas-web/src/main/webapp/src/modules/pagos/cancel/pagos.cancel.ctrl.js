(function (ng) {
    ...
    mod.controller('pagoCancelCtrl', ['$scope', '$http', 'eventosContext', '$state', 'pagoContext','clientesContext',
        /**
         * @ngdoc controller
         * @name pagos.controller:pagoCancelCtrl
         * @description
         * Definición del controlador auxiliar para cancelar un Pagos. 
        ...
        function ($scope, $http, eventosContext, $state, pagoContext,clientesContext) {
            ...
            $scope.cancelPago = function () {
                $http.get(clientesContext + '/' + idCliente + '/' +eventosContext + '/' + idEvento + '/' + pagoContext + '/' + idPago +'/cancel', {}).then(function (response) {
