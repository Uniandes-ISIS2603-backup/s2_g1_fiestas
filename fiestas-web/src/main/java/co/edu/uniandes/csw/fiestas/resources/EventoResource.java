...
public class EventoResource {
    ...
    private List<ContratoEntity> contratosListDTO2Entity(List<ContratoDetailDTO> dtos) {
        ...
        /**
     * <h1>GET /{eventosId}/pagos/ : Obtener todos los pagos de un
     * evento.</h1>
     *
     * <pre>Busca y devuelve todos los pagos que existen en el evento.
     *
     * Codigos de respuesta:
     * <code style="color: mediumseagreen; background-color: #eaffe0;">
     * 200 OK Devuelve todos los pagos del evento.</code>
     * </pre>
     *
     * @param eventosId Identificador del evento que se esta buscando. Este debe
     * ser una cadena de dígitos.
     * @return JSONArray {@link PagoDetailDTO} - Los pagos encontrados
     * en el evento. Si no hay ninguno retorna una lista vacía.
     */
    @GET
    @Path("{eventosId: \\d+}/pagos")
    public List<PagoDetailDTO> listPagos(@PathParam("eventosId") Long eventosId) {
        return pagosListEntity2DTO(eventoLogic.getPagos(eventosId));
    }

    /**
     * <h1>PUT /{eventosId}/pagos: Edita lospagos de un evento..</h1>
     * <pre> Remplaza las instancias de Pago asociadas a una instancia de Evento
     *
     * Codigos de respuesta:
     * <code style="color: mediumseagreen; background-color: #eaffe0;">
     * 200 OK Guardó los pagos del evento.
     * </code>
     * </pre>
     *
     * @param eventosId Identificador del evento que se esta buscando. Este debe
     * ser una cadena de dígitos.
     * @param pagos JSONArray {@link PagoDetailDTO} El arreglo de
     * pagos nuevo para la evento.
     * @return JSON {@link PagoDetailDTO} - El arreglo de pagos guardado
     * en la evento.
     */
    @PUT
    @Path("{eventosId: \\d+}/pagos")
    public List<PagoDetailDTO> replacePagos(@PathParam("eventosId") Long eventosId, List<PagoDetailDTO> pagos) {
        return pagosListEntity2DTO(eventoLogic.replacePagos(eventosId, pagosListDTO2Entity(pagos)));
    }

    /**
     * <h1>POST /{eventosId}/pagos/{pagosId} : Guarda un pago dentro
     * del evento.</h1>
     *
     * <pre> Guarda un pago dentro de un evento con la informacion que
     * recibe en la URL. Se devuelve el pago que se guarda en la evento.
     *
     * Codigos de respuesta:
     * <code style="color: mediumseagreen; background-color: #eaffe0;">
     * 200 OK Guardó el nuevo pago .
     * </code>
     * </pre>
     *
     * @param eventosId Identificador del evento que se esta buscando. Este debe
     * ser una cadena de dígitos.
     * @param pagoId Identificador del pago que se desea guardar. Este
     * debe ser una cadena de dígitos.
     * @return JSON {@link PagoDetailDTO} - El pago guardado en la
     * evento.
     */
    @POST
    @Path("{eventosId: \\d+}/pagos/{pagosId: \\d+}")
    public PagoDetailDTO addPago(@PathParam("eventosId") Long eventosId, @PathParam("pagosId") Long pagoId) {
        return new PagoDetailDTO(eventoLogic.addPago(pagoId, eventosId));
    }

    /**
     * <h1>DELETE /{eventosId}/pagos/{pagosId} : Elimina un pago
     * dentro del evento.</h1>
     *
     * <pre> Elimina la referencia del pago asociado al ID dentro del evento
     * con la informacion que recibe en la URL.
     *
     * Codigos de respuesta:
     * <code style="color: mediumseagreen; background-color: #eaffe0;">
     * 200 OK Se eliminó la referencia del pago.
     * </code>
     * </pre>
     *
     * @param eventosId Identificador del evento que se esta buscando. Este debe
     * ser una cadena de dígitos.
     * @param pagosId Identificador del pago que se desea guardar. Este
     * debe ser una cadena de dígitos.
     */
    @DELETE
    @Path("{eventosId: \\d+}/pagos/{pagosId: \\d+}")
    public void removePagos(@PathParam("eventosId") Long eventosId, @PathParam("pagosId") Long pagosId) {
        eventoLogic.removePago(pagosId, eventosId);
    }

    /**
     * <h1>GET /{eventosId}/pagos/{pagosId} : Obtener pago por id
     * del evento por id.</h1>
     *
     * <pre>Busca el pago con el id asociado dentro del evento con id asociado.
     *
     * Codigos de respuesta:
     * <code style="color: mediumseagreen; background-color: #eaffe0;">
     ...
     * </code>
     * <code style="color: #c7254e; background-color: #f9f2f4;">
     * 404 Not Found No existe un pago con el id dado dentro del evento.
     * </code>
     * </pre>
     *
     * @param eventosId Identificador del evento que se esta buscando. Este debe
     * ser una cadena de dígitos.
     * @param pagosId Identificador del pago que se esta buscando. Este
     * debe ser una cadena de dígitos.
    ...
    @GET
    @Path("{eventosId: \\d+}/pagos/{pagosId: \\d+}")
    public PagoDetailDTO getPago(@PathParam("eventosId") Long eventosId, @PathParam("pagosId") Long pagosId) throws BusinessLogicException {
        return new PagoDetailDTO(eventoLogic.getPago(eventosId, pagosId));
    }
