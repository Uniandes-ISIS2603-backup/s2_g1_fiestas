 ...
 * este recurso tiene la ruta "eventos".</i>
 *
 * <h2>Anotaciones </h2>
 * <pre>
...
public class EventoResource {
     ...
     * </pre>
     * @return JSONArray {@link EventoDetailDTO} - Los eventos encontrados en la aplicación. Si no hay ninguno retorna una lista vacía.
     */
    @GET
...
/**
     ...
     * </code>
     * </pre>
     * @param evento {@link EventoDetailDT} - La ciudad que se desea guardar.
     * @return JSON {@link EventoDetailDTO}  - El evento guardado con el atributo id autogenerado.
