...
insert into ProductoEntity(id,nombre,precio,descripcion,incluye,personal) values(10017,'Servicio de audio para boda',300000, 'DJ para bioda','Incluye lo que necesite el dj, más parlantes incluye varios estilos de musica',6);
