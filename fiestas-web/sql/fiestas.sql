...
insert into ProveedorEntity(id, nombre, documento, telefono, correo, direccion, login, contraseña, penalizado) values(10011, 'Jesús Pradilla', '1012345678', 3212121212, 'j.pradilla@hotmail.com', 'cll.2 #20-32','j.pradilla','hola123', 0);
insert into ProveedorEntity(id, nombre, documento, telefono, correo, direccion, login, contraseña, penalizado) values(10012, 'Diana Fernández Galán', '1012345679', 3212121213, 'dianagalan@yahoo.es', 'cll.2 #20-33','df.galan','hola1234', 0);
insert into ProveedorEntity(id, nombre, documento, telefono, correo, direccion, login, contraseña, penalizado) values(10013, 'Andrés Felip Segura Hernández', '1012345670', 3212121214, 'andresillo@hotmail.com', 'cll.2 #20-34','af.segura10','hola', 1);
