...
insert into ClienteEntity(id, nombre, imagen, documento, telefono, correo, direccion, login, contrasena) values(10011, 'Nicolás Hernández','https://www.psicoactiva.com/blog/wp-content/uploads/2017/07/hombre-soltero-feliz.jpg', '1012345681', 3112121212, 'nm.hernandez10@uniandes.edu.co', 'cll.2 #25-25','nicos', 'asd123');
insert into ClienteEntity(id, nombre, imagen, documento, telefono, correo, direccion, login, contrasena) values(10012, 'Sofía Arias','https://static.iris.net.co/semana/upload/images/2015/10/23/447377_20029_1.jpg' ,'1012345682', 3112121213, 's.arias@uniandes.edu.co', 'cll.94 # 7-12','sofia', 'asd123');
insert into ClienteEntity(id, nombre, imagen, documento, telefono, correo, direccion, login, contrasena) values(10013, 'Cristian Amaya','https://files.merca20.com/uploads/2013/08/shutterstock_130105307.jpg' ,'1012345683', 3112121214, 'cm.amaya11@uniandes.edu.co', 'cll.95 #10-1','cm.amaya', 'asd123');
...
insert into ContratoEntity(id, estado, tyc, valor, proveedor_id,horario_id,evento_id) values(10001, 'Por pagar', 'Sin términos ni condiciones', 2000000000, 10011,10001,10001);
insert into ContratoEntity(id, estado, tyc, valor, proveedor_id, horario_id,evento_id) values(10002, 'Pagada la primera cuota', 'Si el cliente cancela despues de 2 semanas de haber contratado el servicio deberá pagar el 100% del costo', 345000000, 10011, 10002,10001);
insert into ContratoEntity(id, estado, tyc, valor, proveedor_id,horario_id,evento_id) values(10003, 'Pagado', 'Sin términos ni condiciones', 20000000, 10011,10003,10002);
